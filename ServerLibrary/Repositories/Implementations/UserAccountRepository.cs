...
namespace ServerLibrary.Repositories.Implementations
{
    public class UserAccountRepository(IOptions<JwtSection> config, AppDbContext appDbContext) : IUserAccount
    {
        ...
        {
            if(user is null) return new GeneralResponse(false,"Model is empyty");
        ...
        public async Task<LoginResponse> SignInAsync(Login user)
        {
            ...
            {
                // Si el usuario no tiene un token de actualización, crea uno nuevo
                appDbContext.RefreshTokenInfos.Add(new RefreshTokenInfo { UserId = applicationUser.Id, Token = refreshToken });
            }
            await appDbContext.SaveChangesAsync();
