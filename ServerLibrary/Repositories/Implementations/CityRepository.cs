...
namespace ServerLibrary.Repositories.Implementations
{
    public class CityRepository(AppDbContext appDbContext) : IGenericRepositoryInterface<City>
    {
        ...
        private static GeneralResponse NotFound() => new(false, "Sorry Cities not found");
        ...
        public Task<List<City>> GetByEmployeeId(int employeeId)
        {
            throw new NotImplementedException();
        }

        public Task<List<City>> GetByEmployeeEmail(string email)
        {
            throw new NotImplementedException();
        }
    }
